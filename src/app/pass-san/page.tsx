...
export const metadata: Metadata = {
  title: "Pass Sân / Nhượng Sân",
  description: "Tổng hợp các sân cầu lông đang pass, nhượng lại tại Đà Nẵng. Tìm sân trống nhanh chóng.",
  openGraph: {
    title: "Pass Sân Cầu Lông - Danang Badminton Hub",
    description: "Tổng hợp các sân cầu lông đang pass, nhượng lại tại Đà Nẵng. Cập nhật liên tục.",
  },
};
...
export default async function VangLaiPage(props: Props) {
  ...
  const posts = await getPosts(searchTerms, level, type || "cho_thue_san");
    ...
    <div className="container mx-auto px-4 py-12 max-w-6xl">
      ...
      <div className="mb-10 text-center">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
          Tổng hợp các nhóm đang pass sân, nhượng lại sân cầu lông tại Đà Nẵng.
          Giải cứu sân trống nhanh chóng.
        </p>
        <SearchBar />
      </div>
      ...
      {/* Main Content Area */}
      {posts.length === 0 ? (
        <div className="text-center py-20 bg-orange-50/50 rounded-2xl border border-orange-100">
          <p className="text-lg text-orange-600 font-medium">
            Hiện chưa có thông tin pass sân mới nào. Bot đang cào tự động, vui lòng
